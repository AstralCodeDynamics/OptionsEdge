...
Frontend React app calls .NET Minimal APIs over HTTPS and listens to SignalR `/hubs/market`.

Backend uses feature folders, services, background workers, EF Core, PostgreSQL, and market data infrastructure.
