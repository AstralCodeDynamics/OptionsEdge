...
- Dashboard refreshes Groww-backed market snapshots, status, indicators, and
  candles every 30 seconds.
...
`docs/ai` now holds structured AI artefacts for Claude Coworker and Codex.

`docs/AI_HANDOFF.md` remains chronological change log.
