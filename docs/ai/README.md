...
- Codex implements approved tasks, runs validation, updates handoffs, and never changes app behavior outside the task file.

- Claude Coworker / Claude AI is Architect, Consultant, and Reviewer.

- Claude designs changes, asks architecture questions, writes precise task files, and reviews Codex output.
...
7. `PASS` and `PASS WITH NOTES` reviews go under `docs/ai/reviews/passed/`.

8. `FAIL` reviews go under `docs/ai/reviews/failed/`.

9. Completed task artefact moves to `docs/ai/tasks/completed/`.
